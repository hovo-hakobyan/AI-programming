...
public:
	...
	Elite::Vector2 GetPreviousPosition() const { return m_PreviousPosition; }
	void SetPreviousPosition(const Elite::Vector2& pos) { m_PreviousPosition = pos; }

protected:
	RigidBody* m_pRigidBody = nullptr;
	float m_Radius = 1.f;
	Elite::Color m_BodyColor = { 1,1,0,1 };
	Elite::Vector2 m_PreviousPosition;
